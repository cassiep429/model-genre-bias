        ...
        for input_ids in examples["input_ids"]:
            ...
            for position, word in enumerate(words):
                for augmentation_words in bias_attribute_words:
                    ...
                    if r1_word == word:
                        augmented = True
                        augmented_sentence[position] = augmentation_words[r1_augmentation_pair]

                    if r2_word == word:
                        augmented = True
                        augmented_sentence[position] = augmentation_words[r2_augmentation_pair]

                    if r3_word == word:
                        augmented = True
                        augmented_sentence[position] = augmentation_words[r3_augmentation_pair]
